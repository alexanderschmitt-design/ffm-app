...
begin
  ...
  -- Correct-answer position is shuffled across questions (2·A, 1·B, 2·C)
  ...
  insert into public.answer_options (question_id, label, is_correct, position) values
    -- Q1 GPC lines of code: 907,000 — correct at C
    (v_q1, '90,000',    false, 0),
    (v_q1, '9,000,000', false, 1),
    (v_q1, '907,000',   true,  2),

    -- Q2 Absolute zero: -273.15 °C — correct at A
    (v_q2, '-273.15 °C', true,  0),
    (v_q2, '-100 °C',    false, 1),
    (v_q2, '-1,000 °C',  false, 2),

    -- Q3 Fahrenheit / Celsius crossover: -40° — correct at C
    (v_q3, '0°',   false, 0),
    (v_q3, '40°',  false, 1),
    (v_q3, '-40°', true,  2),

    -- Q4 Heaviest KDB base unit: 7,089.8 kg — correct at B
    (v_q4, '708.98 kg',  false, 0),
    (v_q4, '7,089.8 kg', true,  1),
    (v_q4, '70,898 kg',  false, 2),

    -- Q5 Cheapest list price: €626 — correct at A
    (v_q5, '€626',   true,  0),
    (v_q5, '€62.60', false, 1),
    (v_q5, '€6,260', false, 2);
end $$;
